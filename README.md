...
**"Our team did well - so how can my peer score still be low?"**

Because the project grade and the peer score are answering two completely different questions. The project grade reflects the quality of what your team collectively produced - that mark belongs to the team, and every member shares in it. The peer score asks a separate question: within that team, how was the effort distributed? A lower peer score does not take the team's success away from you; it records how your contribution compared to your teammates' during this project.

There are two distinct situations that can produce this result, and they feel very different.

The first is straightforward: if your teammates consistently drove the work forward while you were less involved, the peer score captures that difference honestly. The second is less obvious and more easily misread as unfair: **you received good ratings - sixes, positive comments - and still ended up with a four.** If this is what happened, the explanation is normalisation, not your peers' opinion of you. A rating of 6 is genuinely above the midpoint of the scale, and your teammates' positive comments are real. But if your whole team rated generously - giving each other 7s and 8s across the board - the group median sits above 5, and the normalisation shifts every score down to re-centre the group. Your 6 becomes a 4 not because your peers thought poorly of you, but because the team as a whole was rated above average, and the system has adjusted everyone proportionally to make scores comparable across teams. The comments and the raw ratings are the honest signal; the normalised score is a relative position within the group after that adjustment.

In both cases, a lower score in a successful team is a more comfortable position than contributing poorly to a struggling one. The peer score is not a judgement on the project, or on you as a student - it is a record of relative contribution within this team, at this time.

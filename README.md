...
Because the project grade and the peer score are answering two completely different questions. The project grade reflects the quality of what your team collectively produced - that mark belongs to the team, and every member shares in it. The peer score asks a separate question: within that team, how was the effort distributed? If your teammates consistently drove the work forward while you were less involved, the peer score captures that difference - without changing the fact that the team succeeded, and without taking that success away from you.

Think of it this way: a sports team can win a match while some players contribute more than others. The win belongs to everyone, but individual ratings still reflect individual performance. Your team's project mark reflects the quality of what you all built together. The peer score then asks - within that shared outcome, how evenly was the work divided? A lower peer score in a successful team means your teammates contributed more than you did to a good result. That is a far more comfortable position than contributing poorly to a struggling team. The peer score is not saying the project went badly, or that you did badly as a student - it is saying that, in this team, at this time, others put in more.
